angular.module("umbraco").controller("davemason", [
    "$scope", "$http", "$timeout", function ($scope, $http, $timeout) {
        ...
        $scope.loadDocumentTypes = function () {
            $scope.loading = true;
            $http.get("/umbraco/backoffice/api/davemasonapi/GetDocumentTypes").then(function (resp) {
        ...
        $scope.generateCode = function (documentTypeId) {
            $scope.loading = true;
            $scope.documentTypeCode = '';
            $http.get("/umbraco/backoffice/api/davemasonapi/GetDocumentTypeCode?documentTypeId=" + documentTypeId).then(function (resp) {
